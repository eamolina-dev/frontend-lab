...
export const PhotographyBudget = () => {
  return (
    <>
      <Hero src='/assets/photography-page/couple-443600_1280.jpg' title='Dario Alvarez' subtitle='Fotografía documental de bodas' />
      <SplitSection />
      <DynamicImageSection />
      ...
      <PricingSection
        ...
        description={
          <>
            Ideal para ceremonias íntimas y celebraciones pequeñas. <br /><br />
            Registro completo de los momentos más importantes, con una mirada natural y espontánea. <br /><br />
            Incluye por ejemplo: <br />
            - Cobertura de ceremonia <br />
            - Sesión breve de pareja <br />
            - Entrega de fotos editadas en alta calidad <br />
      ...
      <PricingSection
        ...
        description={
          <>
            Pensado para parejas que quieren revivir su boda una y otra vez. <br /><br />
            Desde los preparativos hasta la fiesta, cada instante queda documentado con una estética cuidada. <br /><br />
            Incluye por ejemplo: <br />
            - Cobertura desde preparativos hasta fiesta <br />
            - Sesión de pareja extendida <br />
            - Fotos editadas en alta calidad <br />
            - Galería online privada <br />
            - Adelanto de fotos a las 48 hs
          </>
        }
      />
